        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh]">
          <Card className="max-w-md">
            <CardHeader>
              ...
              <CardDescription>
                You need to be signed in to create a game room.
              </CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-blue-600 dark:text-blue-400">
                  Set up a new game with custom settings and invite your friends
                  to play
                </p>
              </div>
            </div>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="block text-center text-blue-700 dark:text-blue-300">
                        3×3
                      </span>
                    </Label>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <Badge className="mt-1 bg-blue-200 text-blue-800 dark:bg-blue-800 dark:text-blue-200">
                          BETA
                        </Badge>
                      </div>
                    </Label>
