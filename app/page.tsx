...
function AuthenticatedContent({
  ...
  return (
    <div className="container mx-auto max-w-6xl">
        ...
        <CardContent className="p-6 md:p-10 relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
            <div className="flex-1 text-center md:text-left">
              ...
              >
                The ultimate Tic Tac Toe experience with multiple game modes,
                customizable boards, and online play.
              </p>
      ...
      <GameModesSection settings={settings} playClickSound={playClickSound} />
    </div>
  );
}
        ...
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex-1">
              <h2 className="text-xl font-bold mb-2">Sign in to play online</h2>
              <p className="text-muted-foreground">
                Create an account or sign in to play with friends, track your
    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              ...
              Perfect for practice or a quick game.
            </p>
        ...
        <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              Challenge a friend on the same device. Take turns making moves and
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              Create or join online games and play with friends or random
        ...
        <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              Create or join tournaments with multiple players and compete for
