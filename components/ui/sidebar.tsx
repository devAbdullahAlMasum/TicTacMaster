...
export function Sidebar({ children, className, ...props }: SidebarProps) {
  ...
  return (
    <aside
      className={cn(
        "h-screen sticky top-0 z-30 flex flex-col border-r bg-background transition-all duration-300",
        expanded ? "w-64" : "w-16",
        className,
      )}
      {...props}
...
export function SidebarTrigger() {
  ...
  return (
    <Button variant="outline" size="icon" onClick={toggleExpanded} className="h-8 w-8">
